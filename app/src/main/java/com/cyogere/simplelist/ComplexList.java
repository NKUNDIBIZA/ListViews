...
public class ComplexList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Person leader = new Person("Leader", "27-12-1992", "Male");
        Person cyprian = new Person("Cyprian", "24-08-1993", "Male");
        Person freddy = new Person("Freddy", "22-01-1987", "Male");
        Person louise = new Person("Louise", "26-01-1978", "Male");
        Person ally1 = new Person("Ally", "22-08-1991", "Male");
        Person leader1 = new Person("Leader", "27-12-1992", "Male");
        ...
        //Create an adapter
        PersonListAdapter adapter = new PersonListAdapter(this,R.layout.adapter_view_layout);
