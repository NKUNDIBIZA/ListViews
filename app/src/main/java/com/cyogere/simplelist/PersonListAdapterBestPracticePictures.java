...
public class PersonListAdapterBestPracticePictures extends ArrayAdapter<Person> {

    private Context mContext;
    private int mResource;
    private int lastPosition = -1;

    public PersonListAdapterBestPracticePictures(@NonNull Context context, int resource, @NonNull ArrayList<Person> objects) {
